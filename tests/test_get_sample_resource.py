...
@pytest.mark.parametrize(
    ...
    [
        ("5e8e793e-b7b6-4ad0-ba78-94445ef2a286", 204, "name A"),
        ("cef4485f-fed7-48e3-99c6-47da4c04a894", 204, "name B"),
        (None, 422, None),
        ("76805766-c436-405f-beb2-735075124a6e", 204, None),
        ("c0a207d1-1734-4052-b127-4845eb9d40bb", 204, None),
    ]
)
async def test_get_sample_resource(
    client, override_get_db, clear_db, resource_id: UUID, expected_status: int, expected_name: str
):
    req_params = {}
